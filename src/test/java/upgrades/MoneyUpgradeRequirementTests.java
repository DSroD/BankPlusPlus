...
public class MoneyUpgradeRequirementTests {
    ...
    public void playerHasEnoughMoneySingleManager() {
        ...
        final var requirement = new MoneyUpgradeRequirement(new BigDecimal("100"), List.of(manager));
    ...
    public void playerHasEnoughMoneyMultipleMangers1() {
        ...
        final var requirement = new MoneyUpgradeRequirement(new BigDecimal("10"), List.of(manager1, manager2));
    ...
    public void playerHasEnoughMoneyMultipleMangers2() {
        final var manager1 = new MockEconomyManager();
        final var manager2 = new MockEconomyManager();
        final var requirement = new MoneyUpgradeRequirement(new BigDecimal("50"), List.of(manager1, manager2));
        ...
        assertEquals(new BigDecimal("10"), manager2.getBalance(null));
    }
    ...
    public void playerHasNotEnoughMoney() {
        ...
        final var requirement = new MoneyUpgradeRequirement(new BigDecimal("70"), List.of(manager1, manager2));
        manager1.deposit(null, new BigDecimal("30"));
        manager2.deposit(null, new BigDecimal("30"));
